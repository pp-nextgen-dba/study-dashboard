...
if(
    !savedData ||
    savedData.chapters.length !== defaultData.chapters.length
){
...
function renderTable(){
    ...
    data.chapters.forEach((chapter, index) => {
        ...
        const confidenceSlider =
            document.getElementById(`confidence-${index}`);

        const confidenceText =
            document.getElementById(`confidenceText-${index}`);
        ...
        confidenceSlider.addEventListener("change", () => {
            ...
            data.chapters[index].confidence =
                parseInt(confidenceSlider.value);
    ...
    document.getElementById("totalChapters")
        .innerText = data.chapters.length;
    ...
    document.getElementById("completionPercent")
        .innerText =
        Math.round(
            completed / data.chapters.length * 100
        ) + "%";
